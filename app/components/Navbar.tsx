...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { name: 'Skills', href: '#Skillsection', icon: AiFillSketchCircle },
    { name: 'Projects', href: '#project', icon: AiOutlineProject },
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <motion.div
          className="absolute left-0 top-1/2 -translate-y-1/2 w-full h-12.5 
                     bg-linear-to-r from-gray-900/90 to-gray-800/90 
  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute -top-6 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100">
